...
def menu():
    ...
    x ="Welcome to lvm automator"
     y = x.center(80)
     print("hey what u whant to do")
    print("""\n
...
def mount_logical_volume():
 ...
 def web_server():
    os.run("sudo yum install httpd")
    os.run("sudo systemctl start httpd")
    os.run("systemctl stop firewalld")
 
 def fstab():
 os.run(vim /etc/fstab)
 print("yours driver is permentatly mounted")
